       ...
       const chartC = async()=>{
          ...
          .then(response=>{
             for(const  dataObj of response.data){ 
                 if(dataObj.isp==="Forthnet"){
                   waitF.push(parseInt(dataObj.wait))
                   createdA.push(dataObj.createdAt)
                 }else if(dataObj.isp==="Cosmote"){
                    waitC.push(parseInt(dataObj.wait))
                    createdA.push(dataObj.createdAt)
                }else if(dataObj.isp==="Vodafone"){
                    waitV.push(parseInt(dataObj.wait))
                    createdA.push(dataObj.createdAt)
                }else if(dataObj.content_type==="OTE"){
